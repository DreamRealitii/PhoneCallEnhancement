...
import com.example.phonecallenhancement.APIExplore.APIClient;
import com.example.phonecallenhancement.APIExplore.APIInterface;
...
public class OtherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        responseText = this.findViewById(R.id.responseText);
